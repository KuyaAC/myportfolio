...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Developed a movie recommendation web application using ReactJS, styled with Tailwind CSS, and integrated with the TMDB (The Movie Database) API to fetch and display dynamic movie data and recommendations",
    image:
      "https://github.com/KuyaAC/myportfolio/blob/master/images/Moovie.png?raw=true",
  ...
  },
  {
    ...
    description:
      "Developed an e-commerce platform with product management, user authentication, and secure transactions. Designed and managed a relational database using SQL, implementing CRUD operations for inventory and users. Implemented the front-end using HTML, CSS, and JavaScript.",
    image:
      "https://github.com/KuyaAC/myportfolio/blob/master/images/DigitalInk.png?raw=true",
  ...
  },
  {
    ...
    description:
      "Developed a weather application using ReactJS, incorporating Tailwind CSS for styling, TanStack Query for efficient data fetching and caching, Recharts for data visualization, and ShadcnUI for a modern user interface. Integrated the OpenWeatherAPI to retrieve real-time weather data.",
    image:
      "https://github.com/KuyaAC/myportfolio/blob/master/images/KlimaSS.png?raw=true",
    tags: [
      "ReactJS",
      "TypeScript",
      "OpenWeatherAPI",
  ...
  },
  {
    ...
    category: "web app",
    github: "https://github.com/KuyaAC/calcu",
    webapp: "https://kuyaac.github.io/calcu/",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    webapp: "https://github.com/KuyaAC/Youtube_clone",
  },
  {
    id: 7,
    title: "To Do App",
    ...
    webapp: "https://github.com/KuyaAC/Crud_Laravel",
  },
  {
    id: 8,
